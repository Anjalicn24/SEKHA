...
require_once('config/config.php');
  require_once(ABSPATH.'classes/report.php');
  if(!isset($_SESSION['islogedin'])){
    header('location:login.php');
  }
  $obj_addreport = new report;
  
  $user_id  = $_SESSION['tutorid'];
  
$res = $obj_addreport->report($user_id);

if(isset($_POST['submit'])){

    $arrclass['tutor_id'] = $_SESSION['tutorid'];
    $arrclass['name'] = $res['tutor_name'];
      $arrclass['email'] = $res['tutor_email']; 
      $arrclass['message']=$_POST['message'];
      $arrclass['isreplied'] = 0;
      $arrclass['date']=date('Y/m/d');
      $arrclass['user_type']= 2;
...
<body>
    ...
    <div class="bgBack py-5 mt-5">
        <div class="container">
            ...
            Enter your feedbacks and problems regarding this site you will get answer soon in the mail id you are provided
